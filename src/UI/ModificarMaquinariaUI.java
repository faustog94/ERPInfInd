 ...
 * @author Yair
 */
public class ModificarMaquinariaUI extends javax.swing.JFrame {

 
    public ModificarMaquinariaUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificar maquinaria");

        jLabel2.setText("Código de maquinaria:");

        jLabel3.setText("Descripción:");

        jLabel4.setText("ID maquinaria:");
