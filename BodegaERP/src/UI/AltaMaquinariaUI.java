 ...
 * @author Yair
 */
public class AltaMaquinariaUI extends javax.swing.JFrame {

    /**
     * Creates new form AltaMaquinariaUI
     */
    public AltaMaquinariaUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alta de maquinaria");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaMaquinariaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltaMaquinariaUI().setVisible(true);
            }
        });
    }
