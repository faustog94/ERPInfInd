 ...
 * @author Yair
 */
public class ModificarRutaFabUI extends javax.swing.JFrame {

    public ModificarRutaFabUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificar ruta de fabricación");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activa", "No activa", " " }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ModificarRutaFabUI().setVisible(true);
        });
    }
